    ...
    <>
      ...
      <svg width="0" height="0" aria-hidden="true" style={{ position: 'absolute' }}>
        ...
        <symbol id="avatar-sil" viewBox="0 0 454 482">
          <path d={AVATAR_PATH} fill="url(#silg)" />
        </symbol>
      </svg>
    </>
  );
